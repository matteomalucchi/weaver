...
class ParticleNetEdgeTagger(nn.Module):
    ...
    def forward(self, pf_points, pf_features, pf_mask, sv_points, sv_features, sv_mask, edge_list, edge_features, edge_features_mask):
        ...
        return self.pn(points, features, edge_list, edge_features, mask) # call the forward of particle net
